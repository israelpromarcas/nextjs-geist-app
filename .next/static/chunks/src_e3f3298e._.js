...
"[project]/src/app/dashboard/usuarios/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function UsuariosPage() {
    ...
    const isSuperAdmin = currentUser?.email === "goes95@gmail.com";
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UsuariosPage.useEffect": ()=>{
            const fetchData = {
                "UsuariosPage.useEffect.fetchData": async ()=>{
                    try {
                        // Fetch companies first
                        const companiesSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "companies"));
                        const companiesData = companiesSnap.docs.map({
                            "UsuariosPage.useEffect.fetchData.companiesData": (doc)=>({
                                    id: doc.id,
                                    razaoSocial: doc.data().razaoSocial
                                })
                        }["UsuariosPage.useEffect.fetchData.companiesData"]);
                        setCompanies(companiesData);
                        // Then fetch users based on permissions
                        let usersQuery;
                        if (isSuperAdmin) {
                            usersQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "Users");
                        } else {
                            // Regular admin only sees users from their company
                            usersQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "Users"), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["where"])("empresa", "==", currentUser?.uid));
                        }
                        const usersSnap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(usersQuery);
                        const usersData = usersSnap.docs.map({
                            "UsuariosPage.useEffect.fetchData.usersData": (doc)=>({
                                    id: doc.id,
                                    ...doc.data()
                                })
                        }["UsuariosPage.useEffect.fetchData.usersData"]);
                        setUsers(usersData);
                    } catch (error) {
                        console.error("Error fetching data:", error);
                    }
                }
            }["UsuariosPage.useEffect.fetchData"];
            fetchData();
        }
    }["UsuariosPage.useEffect"], [
        currentUser,
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$68039fd7$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__ab__as__createUserWithEmailAndPassword$3e$__["createUserWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], newUser.email, newUser.senha);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        fileName: "[project]/src/app/dashboard/usuarios/page.tsx",
                        lineNumber: 129,
                        columnNumber: 9
                    }, this),
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: `px-3 py-1 rounded-full text-sm ${user.status === "ativo" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`,
                                            children: user.status === "ativo" ? "Ativo" : "Inativo"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/dashboard/usuarios/page.tsx",
                                            lineNumber: 256,
                                            columnNumber: 17
...
_s(UsuariosPage, "6DKTlewTOEzfKowFqLsRxKn3n2c=", false, function() {
    return [
...
//# sourceMappingURL=src_e3f3298e._.js.map